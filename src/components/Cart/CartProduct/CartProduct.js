    ...
    return (
        <div className="cart-product">
            ...
            <div className="cart-product-price">
                <span className="cart-product-price-price">{(props.product.price * props.amount).toLocaleString()}원</span>
                {
                    props.product.isDiscount &&
                    <span className="cart-product-price-discount">{(props.product.priceBeforeDiscount * props.amount).toLocaleString()}원</span>
                }
            </div>
